...
const PLAYER_NAME_MAPPING = {
  // Mexico
  "Mexico:Ochoa": "Guillermo Ochoa",
  "Mexico:Montes": "César Montes",
  "Mexico:Vásquez": "Johan Vásquez",
  "Mexico:Gallardo": "Jesús Gallardo",
  "Mexico:Sánchez": "Jorge Sánchez",
  "Mexico:Edson Álvarez": "Edson Álvarez",
  "Mexico:Chávez": "Luis Chávez",
  "Mexico:Pineda": "Orbelín Pineda",
  "Mexico:Lozano": "Hirving Lozano",
  "Mexico:Santiago Giménez": "Santiago Giménez",
  "Mexico:Antuna": "Uriel Antuna",
  // South Africa
  "South Africa:Williams": "Ronwen Williams",
  "South Africa:Mudau": "Khuliso Mudau",
  "South Africa:Mvala": "Mothobi Mvala",
  "South Africa:Kekana": "Grant Kekana",
  "South Africa:Modiba": "Aubrey Modiba",
  "South Africa:Mokoena": "Teboho Mokoena",
  "South Africa:Sithole": "Sphephelo Sithole",
  "South Africa:Zwane": "Themba Zwane",
  "South Africa:Morena": "Thapelo Morena",
  "South Africa:Tau": "Percy Tau",
  "South Africa:Makgopa": "Evidence Makgopa",
  // South Korea / Korea Republic
  "South Korea:Jo": "Jo Hyeon-woo",
  "South Korea:Kim Min-jae": "Kim Min-jae",
  "South Korea:Jung": "Jung Woo-young",
  "South Korea:Seol": "Seol Young-woo",
  "South Korea:Lee Ki-je": "Lee Ki-je",
  "South Korea:Hwang In-beom": "Hwang In-beom",
  "South Korea:Park": "Park Yong-woo",
  "South Korea:Lee Kang-in": "Lee Kang-in",
  "South Korea:Son Heung-min": "Son Heung-min",
  "South Korea:Hwang Hee-chan": "Hwang Hee-chan",
  "South Korea:Cho": "Cho Gue-sung",
  "Korea Republic:Jo": "Jo Hyeon-woo",
  "Korea Republic:Kim Min-jae": "Kim Min-jae",
  "Korea Republic:Jung": "Jung Woo-young",
  "Korea Republic:Seol": "Seol Young-woo",
  "Korea Republic:Lee Ki-je": "Lee Ki-je",
  "Korea Republic:Hwang In-beom": "Hwang In-beom",
  "Korea Republic:Park": "Park Yong-woo",
  "Korea Republic:Lee Kang-in": "Lee Kang-in",
  "Korea Republic:Son Heung-min": "Son Heung-min",
  "Korea Republic:Hwang Hee-chan": "Hwang Hee-chan",
  "Korea Republic:Cho": "Cho Gue-sung",
  // Czechia
  "Czechia:Stanek": "Jindřich Staněk",
  "Czechia:Holes": "Tomáš Holeš",
  "Czechia:Hranac": "Robin Hranáč",
  "Czechia:Krejci": "Ladislav Krejčí",
  "Czechia:Coufal": "Vladimír Coufal",
  "Czechia:Soucek": "Tomáš Souček",
  "Czechia:Provod": "Lukáš Provod",
  "Czechia:Doudera": "David Douděra",
  "Czechia:Barak": "Antonín Barák",
  "Czechia:Hlozek": "Adam Hložek",
  "Czechia:Schick": "Patrik Schick",
  // USA
  "USA:Turner": "Matt Turner",
  "USA:Dest": "Sergiño Dest",
  "USA:Richards": "Chris Richards",
  "USA:Ream": "Tim Ream",
  "USA:Robinson": "Antonee Robinson",
  "USA:McKennie": "Weston McKennie",
  "USA:Adams": "Tyler Adams",
  "USA:Musah": "Yunus Musah",
  "USA:Weah": "Timothy Weah",
  "USA:Balogun": "Folarin Balogun",
  "USA:Christian Pulisic": "Christian Pulisic",
  // Romania
  "Romania:Nita": "Florin Niță",
  "Romania:Ratiu": "Andrei Rațiu",
  "Romania:Dragusin": "Radu Drăgușin",
  "Romania:Burca": "Andrei Burcă",
  "Romania:Bancu": "Nicușor Bancu",
  "Romania:M. Marin": "Marius Marin",
  "Romania:Man": "Dennis Man",
  "Romania:R. Marin": "Răzvan Marin",
  "Romania:Stanciu": "Nicolae Stanciu",
  "Romania:Mihaila": "Valentin Mihăilă",
  "Romania:Dragus": "Denis Drăguș",
  // Paraguay
  "Paraguay:Coronel": "Carlos Miguel Coronel",
  "Paraguay:Balbuena": "Fabián Balbuena",
  "Paraguay:Alderete": "Omar Alderete",
  "Paraguay:Espinoza": "Matías Espinoza",
  "Paraguay:Caceres": "Gustavo Velázquez",
  "Paraguay:Cubas": "Andrés Cubas",
  "Paraguay:Villasanti": "Mathías Villasanti",
  "Paraguay:Diego Gomez": "Diego Gómez",
  "Paraguay:Almiron": "Miguel Almirón",
  "Paraguay:Enciso": "Julio Enciso",
  "Paraguay:Sanabria": "Antonio Sanabria",
  // Australia
  "Australia:Ryan": "Mathew Ryan",
  "Australia:Atkinson": "Nathaniel Atkinson",
  "Australia:Rowles": "Kye Rowles",
  "Australia:Souttar": "Harry Souttar",
  "Australia:Behich": "Aziz Behich",
  "Australia:Baccus": "Keanu Baccus",
  "Australia:Irvine": "Jackson Irvine",
  "Australia:Metcalfe": "Connor Metcalfe",
  "Australia:Goodwin": "Craig Goodwin",
  "Australia:Boyle": "Martin Boyle",
  "Australia:Duke": "Mitchell Duke",
  // Canada
  "Canada:Crepeau": "Maxime Crépeau",
  "Canada:Johnston": "Alistair Johnston",
  "Canada:Miller": "Kamal Miller",
  "Canada:Bombito": "Moïse Bombito",
  "Canada:Alphonso Davies": "Alphonso Davies",
  "Canada:Eustaquio": "Stephen Eustáquio",
  "Canada:Kone": "Ismaël Koné",
  "Canada:Buchanan": "Tajon Buchanan",
  "Canada:Jonathan David": "Jonathan David",
  "Canada:Larin": "Cyle Larin",
  "Canada:Millar": "Liam Millar",
  // Wales
  "Wales:Ward": "Danny Ward",
  "Wales:Roberts": "Connor Roberts",
  "Wales:Mepham": "Chris Mepham",
  "Wales:Davies": "Ben Davies",
  "Wales:Williams": "Neco Williams",
  "Wales:Ampadu": "Ethan Ampadu",
  "Wales:J. James": "Jordan James",
  "Wales:Wilson": "Harry Wilson",
  "Wales:Brooks": "David Brooks",
  "Wales:Johnson": "Brennan Johnson",
  "Wales:James": "Daniel James",
  // Qatar
  "Qatar:Barsham": "Meshaal Barsham",
  "Qatar:Miguel": "Pedro Miguel",
  "Qatar:Mukhtar": "Al-Mahdi Ali Mukhtar",
  "Qatar:Mendes": "Lucas Mendes",
  "Qatar:Al-Rawi": "Bassam Al-Rawi",
  "Qatar:Waad": "Mohammed Waad",
  "Qatar:Hatem": "Abdulaziz Hatem",
  "Qatar:Fatehi": "Ahmed Fatehi",
  "Qatar:Afif": "Akram Afif",
  "Qatar:Al-Haydos": "Hassan Al-Haydos",
  "Qatar:Ali": "Almoez Ali",
  // Switzerland
  "Switzerland:Sommer": "Yann Sommer",
  "Switzerland:Schär": "Fabian Schär",
  "Switzerland:Akanji": "Manuel Akanji",
  "Switzerland:Rodriguez": "Ricardo Rodriguez",
  "Switzerland:Widmer": "Silvan Widmer",
  "Switzerland:Xhaka": "Granit Xhaka",
  "Switzerland:Freuler": "Remo Freuler",
  "Switzerland:Aebischer": "Michel Aebischer",
  "Switzerland:Ndoye": "Dan Ndoye",
  "Switzerland:Vargas": "Ruben Vargas",
  "Switzerland:Embolo": "Breel Embolo",
  // Brazil
  "Brazil:Alisson": "Alisson Becker",
  "Brazil:Danilo": "Danilo da Silva",
  "Brazil:Marquinhos": "Marquinhos",
  "Brazil:Gabriel": "Gabriel Magalhães",
  "Brazil:Arana": "Guilherme Arana",
  "Brazil:Guimarães": "Bruno Guimarães",
  "Brazil:Gomes": "João Gomes",
  "Brazil:Paquetá": "Lucas Paquetá",
  "Brazil:Raphinha": "Raphinha",
  "Brazil:Rodrygo": "Rodrygo Goes",
  "Brazil:Vinícius Jr.": "Vinícius Júnior",
  // Morocco
  "Morocco:Bounou": "Yassine Bounou",
  "Morocco:Hakimi": "Achraf Hakimi",
  "Morocco:Aguerd": "Nayef Aguerd",
  "Morocco:Saïss": "Romain Saïss",
  "Morocco:Allah": "Yahia Attiyat Allah",
  "Morocco:Amrabat": "Sofyan Amrabat",
  "Morocco:Ounahi": "Azzedine Ounahi",
  "Morocco:Ziyech": "Hakim Ziyech",
  "Morocco:Harit": "Amine Harit",
  "Morocco:Adli": "Amine Adli",
  "Morocco:En-Nesyri": "Youssef En-Nesyri",
  // Haiti
  "Haiti:Placide": "Johny Placide",
  "Haiti:Arcus": "Carlens Arcus",
  "Haiti:Ade": "Ricardo Adé",
  "Haiti:Christian": "Christian Joel",
  "Haiti:Guerrier": "Wilde-Donald Guerrier",
  "Haiti:Alceus": "Bryan Alceus",
  "Haiti:Pierre": "Leverton Pierre",
  "Haiti:Nazon": "Duckens Nazon",
  "Haiti:Etienne": "Derrick Etienne",
  "Haiti:Pierrot": "Frantzdy Pierrot",
  "Haiti:Picault": "Fafà Picault",
  // Scotland
  "Scotland:Gunn": "Angus Gunn",
  "Scotland:Porteous": "Ryan Porteous",
  "Scotland:Hendry": "Jack Hendry",
  "Scotland:Tierney": "Kieran Tierney",
  "Scotland:Ralston": "Anthony Ralston",
  "Scotland:McTominay": "Scott McTominay",
  "Scotland:McGregor": "Callum McGregor",
  "Scotland:Gilmour": "Billy Gilmour",
  "Scotland:Robertson": "Andrew Robertson",
  "Scotland:McGinn": "John McGinn",
  "Scotland:Adams": "Che Adams",
  // Germany
  "Germany:Ter Stegen": "Marc-André ter Stegen",
  "Germany:Kimmich": "Joshua Kimmich",
  "Germany:Rüdiger": "Antonio Rüdiger",
  "Germany:Tah": "Jonathan Tah",
  "Germany:Mittelstädt": "Maximilian Mittelstädt",
  "Germany:Andrich": "Robert Andrich",
  "Germany:Kroos": "Toni Kroos",
  "Germany:Jamal Musiala": "Jamal Musiala",
  "Germany:Gündogan": "Ilkay Gündogan",
  "Germany:Florian Wirtz": "Florian Wirtz",
  "Germany:Havertz": "Kai Havertz",
  // Curaçao
  "Curaçao:Room": "Eloy Room",
  "Curaçao:Gaari": "Juriën Gaari",
  "Curaçao:Martina": "Cuco Martina",
  "Curaçao:Floranus": "Sherel Floranus",
  "Curaçao:J. Bacuna": "Juninho Bacuna",
  "Curaçao:Anita": "Vurnon Anita",
  "Curaçao:L. Bacuna": "Leandro Bacuna",
  "Curaçao:Kuwas": "Brandley Kuwas",
  "Curaçao:Janga": "Rangelo Janga",
  "Curaçao:Gorré": "Kenji Gorré",
  "Curaçao:Locadia": "Jürgen Locadia",
  // Côte d'Ivoire / Ivory Coast
  "Ivory Coast:Fofana": "Yahia Fofana",
  "Ivory Coast:Aurier": "Serge Aurier",
  "Ivory Coast:Ndicka": "Evan Ndicka",
  "Ivory Coast:Boly": "Willy Boly",
  "Ivory Coast:Konan": "Ghislain Konan",
  "Ivory Coast:Kessié": "Franck Kessié",
  "Ivory Coast:Seri": "Jean Michaël Seri",
  "Ivory Coast:Sangaré": "Ibrahim Sangaré",
  "Ivory Coast:Adinga": "Simon Adinga",
  "Ivory Coast:Haller": "Sébastien Haller",
  "Ivory Coast:Pépé": "Nicolas Pépé",
  "Côte d'Ivoire:Fofana": "Yahia Fofana",
  "Côte d'Ivoire:Aurier": "Serge Aurier",
  "Côte d'Ivoire:Ndicka": "Evan Ndicka",
  "Côte d'Ivoire:Boly": "Willy Boly",
  "Côte d'Ivoire:Konan": "Ghislain Konan",
  "Côte d'Ivoire:Kessié": "Franck Kessié",
  "Côte d'Ivoire:Seri": "Jean Michaël Seri",
  "Côte d'Ivoire:Sangaré": "Ibrahim Sangaré",
  "Côte d'Ivoire:Adinga": "Simon Adinga",
  "Côte d'Ivoire:Haller": "Sébastien Haller",
  "Côte d'Ivoire:Pépé": "Nicolas Pépé",
  // Ecuador
  "Ecuador:Domínguez": "Alexander Domínguez",
  "Ecuador:Preciado": "Angelo Preciado",
  "Ecuador:Torres": "Félix Torres",
  "Ecuador:Hincapié": "Piero Hincapié",
  "Ecuador:Estupiñán": "Pervis Estupiñán",
  "Ecuador:Gruezo": "Carlos Gruezo",
  "Ecuador:Caicedo": "Moisés Caicedo",
  "Ecuador:Páez": "Kendry Páez",
  "Ecuador:Mena": "Ángel Mena",
  "Ecuador:Sarmiento": "Jeremy Sarmiento",
  "Ecuador:Valencia": "Enner Valencia",
  // Netherlands
  "Netherlands:Verbruggen": "Bart Verbruggen",
  "Netherlands:Dumfries": "Denzel Dumfries",
  "Netherlands:De Vrij": "Stefan de Vrij",
  "Netherlands:Van Dijk": "Virgil van Dijk",
  "Netherlands:Aké": "Nathan Aké",
  "Netherlands:Schouten": "Jerdy Schouten",
  "Netherlands:Reijnders": "Tijjani Reijnders",
  "Netherlands:Simons": "Xavi Simons",
  "Netherlands:Frimpong": "Jeremie Frimpong",
  "Netherlands:Gakpo": "Cody Gakpo",
  "Netherlands:Depay": "Memphis Depay",
  // Ukraine
  "Ukraine:Lunin": "Andriy Lunin",
  "Ukraine:Konoplya": "Yukhym Konoplya",
  "Ukraine:Zabarnyi": "Illia Zabarnyi",
  "Ukraine:Matviyenko": "Mykola Matviyenko",
  "Ukraine:Mykolenko": "Vitaliy Mykolenko",
  "Ukraine:Stepanenko": "Taras Stepanenko",
  "Ukraine:Sudakov": "Heorhiy Sudakov",
  "Ukraine:Zinchenko": "Oleksandr Zinchenko",
  "Ukraine:Tsyhankov": "Viktor Tsyhankov",
  "Ukraine:Mudryk": "Mykhailo Mudryk",
  "Ukraine:Dovbyk": "Artem Dovbyk",
  // Japan
  "Japan:Suzuki": "Zion Suzuki",
  "Japan:Sugawara": "Yukinari Sugawara",
  "Japan:Itakura": "Ko Itakura",
  "Japan:Machida": "Koki Machida",
  "Japan:Ito": "Junya Ito",
  "Japan:Endo": "Wataru Endo",
  "Japan:Morita": "Hidemasa Morita",
  "Japan:Doan": "Ritsu Doan",
  "Japan:Kubo": "Takefusa Kubo",
  "Japan:Mitoma": "Kaoru Mitoma",
  "Japan:Ueda": "Ayase Ueda",
  // Tunisia
  "Tunisia:Ben Said": "Bechir Ben Saïd",
  "Tunisia:Kechrida": "Wajdi Kechrida",
  "Tunisia:Meriah": "Yassine Meriah",
  "Tunisia:Talbi": "Montassar Talbi",
  "Tunisia:Abdi": "Ali Abdi",
  "Tunisia:Skhiri": "Ellyes Skhiri",
  "Tunisia:Laidouni": "Aïssa Laïdouni",
  "Tunisia:Rafia": "Hamza Rafia",
  "Tunisia:Achouri": "Elias Achouri",
  "Tunisia:Ltaief": "Sayfallah Ltaief",
  "Tunisia:Jaziri": "Seifeddine Jaziri",
  // Belgium
  "Belgium:Casteels": "Koen Casteels",
  "Belgium:Castagne": "Timothy Castagne",
  "Belgium:Faes": "Wout Faes",
  "Belgium:Vertonghen": "Jan Vertonghen",
  "Belgium:Theate": "Arthur Theate",
  "Belgium:Onana": "Amadou Onana",
  "Belgium:Mangala": "Orel Mangala",
  "Belgium:Kevin De Bruyne": "Kevin De Bruyne",
  "Belgium:Doku": "Jérémy Doku",
  "Belgium:Trossard": "Leandro Trossard",
  "Belgium:Lukaku": "Romelu Lukaku",
  // Egypt
  "Egypt:El Shenawy": "Mohamed El Shenawy",
  "Egypt:Hany": "Mohamed Hany",
  "Egypt:Abdelmonem": "Mohamed Abdelmonem",
  "Egypt:Hegazi": "Ahmed Hegazi",
  "Egypt:Hamdi": "Ahmed Hamdi",
  "Egypt:Elneny": "Mohamed Elneny",
  "Egypt:Fathi": "Hamdi Fathi",
  "Egypt:Zizo": "Ahmed Sayed (Zizo)",
  "Egypt:Mohamed Salah": "Mohamed Salah",
  "Egypt:Trezeguet": "Trézéguet",
  "Egypt:Mostafa Mohamed": "Mostafa Mohamed",
  // Iran / IR Iran
  "Iran:Beiranvand": "Alireza Beiranvand",
  "Iran:Rezaeian": "Ramin Rezaeian",
  "Iran:Kanaanizadegan": "Hossein Kanaanizadegan",
  "Iran:Khalilzadeh": "Shojae Khalilzadeh",
  "Iran:Hajsafi": "Ehsan Hajsafi",
  "Iran:Ezatolahi": "Saeid Ezatolahi",
  "Iran:Ghoddos": "Saman Ghoddos",
  "Iran:Jahanbakhsh": "Alireza Jahanbakhsh",
  "Iran:Taremi": "Mehdi Taremi",
  "Iran:Azmoun": "Sardar Azmoun",
  "Iran:Mohebi": "Mohammad Mohebi",
  "IR Iran:Beiranvand": "Alireza Beiranvand",
  "IR Iran:Rezaeian": "Ramin Rezaeian",
  "IR Iran:Kanaanizadegan": "Hossein Kanaanizadegan",
  "IR Iran:Khalilzadeh": "Shojae Khalilzadeh",
  "IR Iran:Hajsafi": "Ehsan Hajsafi",
  "IR Iran:Ezatolahi": "Saeid Ezatolahi",
  "IR Iran:Ghoddos": "Saman Ghoddos",
  "IR Iran:Jahanbakhsh": "Alireza Jahanbakhsh",
  "IR Iran:Taremi": "Mehdi Taremi",
  "IR Iran:Azmoun": "Sardar Azmoun",
  "IR Iran:Mohebi": "Mohammad Mohebi",
  // New Zealand
  "New Zealand:Crocombe": "Max Crocombe",
  "New Zealand:Payne": "Tim Payne",
  "New Zealand:Boxall": "Michael Boxall",
  "New Zealand:Pijnaker": "Nando Pijnaker",
  "New Zealand:Cacace": "Liberato Cacace",
  "New Zealand:Garbett": "Matthew Garbett",
  "New Zealand:Stamenic": "Marko Stamenic",
  "New Zealand:Bell": "Joe Bell",
  "New Zealand:Just": "Elijah Just",
  "New Zealand:Wood": "Chris Wood",
  "New Zealand:McCowatt": "Callum McCowatt",
  // Spain
  "Spain:Raya": "David Raya",
  "Spain:Carvajal": "Dani Carvajal",
  "Spain:Le Normand": "Robin Le Normand",
  "Spain:Laporte": "Aymeric Laporte",
  "Spain:Cucurella": "Marc Cucurella",
  "Spain:Rodri": "Rodri",
  "Spain:Ruiz": "Fabián Ruiz",
  "Spain:Pedri": "Pedri",
  "Spain:Yamal": "Lamine Yamal",
  "Spain:Williams": "Nico Williams",
  "Spain:Morata": "Álvaro Morata",
  // Cabo Verde
  "Cabo Verde:Vozinha": "Vozinha",
  "Cabo Verde:Moreira": "Steven Moreira",
  "Cabo Verde:Costa": "Logan Costa",
  "Cabo Verde:Pico": "Roberto Lopes",
  "Cabo Verde:Tavares": "Dylan Tavares",
  "Cabo Verde:Rocha": "Kenny Rocha Santos",
  "Cabo Verde:Pina": "Kevin Pina",
  "Cabo Verde:Monteiro": "Jamiro Monteiro",
  "Cabo Verde:Mendes": "Ryan Mendes",
  "Cabo Verde:Cabral": "Jovane Cabral",
  "Cabo Verde:Bebé": "Bebé",
  // Saudi Arabia
  "Saudi Arabia:Al-Owais": "Mohammed Al-Owais",
  "Saudi Arabia:Al-Bulaihi": "Ali Al-Bulaihi",
  "Saudi Arabia:Lajami": "Ali Lajami",
  "Saudi Arabia:Tambakti": "Hassan Tambakti",
  "Saudi Arabia:Abdulhamid": "Saud Abdulhamid",
  "Saudi Arabia:Al-Khaibari": "Abdullah Al-Khaibari",
  "Saudi Arabia:Kanno": "Mohamed Kanno",
  "Saudi Arabia:Al-Dawsari": "Salem Al-Dawsari",
  "Saudi Arabia:Ghareeb": "Abdulrahman Ghareeb",
  "Saudi Arabia:Al-Muwallad": "Fahad Al-Muwallad",
  "Saudi Arabia:Al-Shehri": "Saleh Al-Shehri",
  // Uruguay
  "Uruguay:Rochet": "Sergio Rochet",
  "Uruguay:Nández": "Nahitan Nández",
  "Uruguay:Araújo": "Ronald Araújo",
  "Uruguay:J. M. Giménez": "José María Giménez",
  "Uruguay:Olivera": "Mathías Olivera",
  "Uruguay:Ugarte": "Manuel Ugarte",
  "Uruguay:Valverde": "Federico Valverde",
  "Uruguay:De la Cruz": "Nicolás de la Cruz",
  "Uruguay:Pellistri": "Facundo Pellistri",
  "Uruguay:Araujo": "Maximiliano Araújo",
  "Uruguay:Darwin Núñez": "Darwin Núñez",
  // Bosnia and Herzegovina
  "Bosnia and Herzegovina:Džeko": "Edin Džeko",
  "Bosnia and Herzegovina:Demirović": "Ermedin Demirović",
  "Bosnia and Herzegovina:Kolašinac": "Sead Kolašinac",
  "Bosnia and Herzegovina:Krunić": "Rade Krunić",
  "Bosnia and Herzegovina:Pirić": "Kenan Pirić",
  "Bosnia and Herzegovina:Hadžikadunić": "Dennis Hadžikadunić",
  "Bosnia and Herzegovina:Ahmedhodžić": "Anel Ahmedhodžić",
  "Bosnia and Herzegovina:Gazibegović": "Jusuf Gazibegović",
  "Bosnia and Herzegovina:Hadžiahmetović": "Amir Hadžiahmetović",
  "Bosnia and Herzegovina:Stevanović": "Miroslav Stevanović",
  "Bosnia and Herzegovina:Cimirot": "Gojko Cimirot",
  // Türkiye
  "Türkiye:Günok": "Mert Günok",
  "Türkiye:Çelik": "Zeki Çelik",
  "Türkiye:Bardakcı": "Abdülkerim Bardakcı",
  "Türkiye:Akaydin": "Samet Akaydin",
  "Türkiye:Kadıoğlu": "Ferdi Kadıoğlu",
  "Türkiye:Ayhan": "Kaan Ayhan",
  "Türkiye:Kökçü": "Orkun Kökçü",
  "Türkiye:Çalhanoğlu": "Hakan Çalhanoğlu",
  "Türkiye:Güler": "Arda Güler",
  "Türkiye:Yıldız": "Kenan Yıldız",
  "Türkiye:Yılmaz": "Barış Alper Yılmaz",
  // Sweden
  "Sweden:Olsen": "Robin Olsen",
  "Sweden:Krafth": "Emil Krafth",
  "Sweden:Hien": "Isak Hien",
  "Sweden:Lindelöf": "Victor Lindelöf",
  "Sweden:Augustinsson": "Ludwig Augustinsson",
  "Sweden:Cajuste": "Jens Cajuste",
  "Sweden:Salétros": "Anton Salétros",
  "Sweden:Kulusevski": "Dejan Kulusevski",
  "Sweden:Isak": "Alexander Isak",
  "Sweden:Elanga": "Anthony Elanga",
  "Sweden:Gyökeres": "Viktor Gyökeres",
  // Argentina
  "Argentina:Emiliano Martínez": "Emiliano Martínez",
  "Argentina:Molina": "Nahuel Molina",
  "Argentina:Romero": "Cristian Romero",
  "Argentina:Otamendi": "Nicolás Otamendi",
  "Argentina:Tagliafico": "Nicolás Tagliafico",
  "Argentina:De Paul": "Rodrigo De Paul",
  "Argentina:Enzo Fernández": "Enzo Fernández",
  "Argentina:Mac Allister": "Alexis Mac Allister",
  "Argentina:Lionel Messi": "Lionel Messi",
  "Argentina:Julián Álvarez": "Julián Álvarez",
  "Argentina:Lautaro Martínez": "Lautaro Martínez",
  // France
  "France:Maignan": "Mike Maignan",
  "France:Koundé": "Jules Koundé",
  "France:Upamecano": "Dayot Upamecano",
  "France:Saliba": "William Saliba",
  "France:T. Hernández": "Theo Hernández",
  "France:Tchouaméni": "Aurélien Tchouaméni",
  "France:Rabiot": "Adrien Rabiot",
  "France:Antoine Griezmann": "Antoine Griezmann",
  "France:Dembélé": "Ousmane Dembélé",
  "France:Marcus Thuram": "Marcus Thuram",
  "France:Kylian Mbappé": "Kylian Mbappé",
  // Portugal
  "Portugal:Diogo Costa": "Diogo Costa",
  "Portugal:Dalot": "Diogo Dalot",
  "Portugal:Rúben Dias": "Rúben Dias",
  "Portugal:António Silva": "António Silva",
  "Portugal:Cancelo": "João Cancelo",
  "Portugal:Palhinha": "João Palhinha",
  "Portugal:Vitinha": "Vitinha",
  "Portugal:Bruno Fernandes": "Bruno Fernandes",
  "Portugal:Bernardo Silva": "Bernardo Silva",
  "Portugal:Rafael Leão": "Rafael Leão",
  "Portugal:Cristiano Ronaldo": "Cristiano Ronaldo",
  // England
  "England:Pickford": "Jordan Pickford",
  "England:Walker": "Kyle Walker",
  "England:Stones": "John Stones",
  "England:Guehi": "Marc Guéhi",
  "England:Trippier": "Kieran Trippier",
  "England:Rice": "Declan Rice",
  "England:Alexander-Arnold": "Trent Alexander-Arnold",
  "England:Jude Bellingham": "Jude Bellingham",
  "England:Bukayo Saka": "Bukayo Saka",
  "England:Phil Foden": "Phil Foden",
  "England:Harry Kane": "Harry Kane",
  // Croatia
  "Croatia:Livaković": "Dominik Livaković",
  "Croatia:Stanišić": "Josip Stanišić",
  "Croatia:Šutalo": "Josip Šutalo",
  "Croatia:Gvardiol": "Joško Gvardiol",
  "Croatia:Sosa": "Borna Sosa",
  "Croatia:Brozović": "Marcelo Brozović",
  "Croatia:Kovačić": "Mateo Kovačić",
  "Croatia:Luka Modrić": "Luka Modrić",
  "Croatia:Pašalić": "Mario Pašalić",
  "Croatia:Kramarić": "Andrej Kramarić",
  "Croatia:Perišić": "Ivan Perišić",
  // Poland
  "Poland:Szczęsny": "Wojciech Szczęsny",
  "Poland:Bednarek": "Jan Bednarek",
  "Poland:Dawidowicz": "Paweł Dawidowicz",
  "Poland:Kiwior": "Jakub Kiwior",
  "Poland:Frankowski": "Przemysław Frankowski",
  "Poland:Zieliński": "Piotr Zieliński",
  "Poland:Slisz": "Bartosz Slisz",
  "Poland:Piotrowski": "Jakub Piotrowski",
  "Poland:Zalewski": "Nicola Zalewski",
  "Poland:Swiderski": "Karol Świderski",
  "Poland:Robert Lewandowski": "Robert Lewandowski",
  // Norway
  "Norway:Nyland": "Ørjan Nyland",
  "Norway:Ryerson": "Julian Ryerson",
  "Norway:Østigård": "Leo Østigård",
  "Norway:Ajer": "Kristoffer Ajer",
  "Norway:Wolfe": "David Møller Wolfe",
  "Norway:Berge": "Sander Berge",
  "Norway:Ødegaard": "Martin Ødegaard",
  "Norway:Patrick Berg": "Patrick Berg",
  "Norway:Bobb": "Oscar Bobb",
  "Norway:Erling Haaland": "Erling Haaland",
  "Norway:Sørloth": "Alexander Sørloth"
};
...
function generatePlayerProfile(playerName, teamName, posCode) {
  const resolvedName = PLAYER_NAME_MAPPING[`${teamName}:${playerName}`] || playerName;
  let hash = 0;
  for (let i = 0; i < resolvedName.length; i++) {
    hash = resolvedName.charCodeAt(i) + ((hash << 5) - hash);
  }
  ...
  const realData = REAL_PLAYER_STATS[resolvedName];
...
function showPlayerProfile(playerName, teamName, posCode) {
  ...
  const fetchPlayerPhoto = async () => {
    ...
    const setSilhouette = () => {
      if (avatarEl) {
        avatarEl.innerHTML = `<img src="https://cdn.sofifa.net/players/notfound_0_120.png" alt="${profile.name}" style="opacity: 0.7; filter: brightness(0.85); width: 85%; height: 85%; object-fit: contain;">`;
    ...
    try {
      const url = `https://www.thesportsdb.com/api/v1/json/3/searchplayers.php?p=${encodeURIComponent(profile.name)}`;
      ...
      if (res.ok) {
        ...
        if (data && data.player && data.player.length > 0) {
          ...
          if (imgUrl) {
            if (avatarEl) {
              avatarEl.innerHTML = `<img src="${imgUrl}" alt="${profile.name}" style="opacity: 0; transition: opacity 0.3s ease; width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">`;
